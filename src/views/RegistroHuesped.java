...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuespedes() {
		if (txtFechaN.getDate() != null && !txtNombre.equals("") &&
			...
			Huespedes huesped = new Huespedes(txtNombre.getText(), txtApellido.getText(),
					java.sql.Date.valueOf(FechaN), txtNacionalidad.getSelectedItem().toString(),
					txtTelefono.getText(), numeroReserva);
			
			this.huespedesControlador.guardar(huesped);
			
			Exito exito = new Exito();
			exito.setVisible(true);
			dispose();
		} else {
			JOptionPane.showMessageDialog(this, "No ha rellenado todos los campos correctamente");
		}
	}
